...
func TestAdminFederationViewHostsAndUsers(t *testing.T) {
	...
	t.Run("Federation enabled", func(t *testing.T) {
		...
		t.Run("Admin user", func(t *testing.T) {
			...
			assert.Contains(t, hostRows.Eq(0).Text(), "bob.example.com")
			assert.Contains(t, hostRows.Eq(1).Text(), "alice.example.com")
			...
			assert.Contains(t, userRows.Eq(0).Text(), "/api/v1/activitypub/user-id/1/inbox#bob")
			assert.Contains(t, userRows.Eq(1).Text(), "/api/v1/activitypub/user-id/1/inbox#alice")
			assert.Contains(t, userRows.Eq(2).Text(), "/api/v1/activitypub/user-id/2/inbox#eve")
			...
			assert.Contains(t, userRows.Eq(0).Text(), "/api/v1/activitypub/user-id/1/inbox#alice")
			assert.Contains(t, userRows.Eq(1).Text(), "/api/v1/activitypub/user-id/2/inbox#eve")
		})
	})
