	...
	w := &webhook.Webhook{
		...
		HookEvent: &webhook.HookEvent{
			...
			HookEvents: webhook.HookEvents{
				...
				Organization:         util.IsStringInSlice(string(webhook.HookEventOrg), form.Events, true),
				Team:                 util.IsStringInSlice(string(webhook.HookEventTeam), form.Events, true),
				TeamMember:           util.IsStringInSlice(string(webhook.HookEventTeamMember), form.Events, true),
			},
