...
var (
	...
	mentionPattern = regexp.MustCompile(`(?:\s|^|\(|\[)(@[0-9a-zA-Z-_]+|@[0-9a-zA-Z-_]+\/?[0-9a-zA-Z-_]+|@[0-9a-zA-Z-_][0-9a-zA-Z-_.]+\/?[0-9a-zA-Z-_.]+[0-9a-zA-Z-_]|@[0-9a-zA-Z-_][0-9a-zA-Z-_.]+@(?:[0-9a-z][0-9a-z-]*\.)+[0-9a-z][0-9a-z-]*)(?:'|\s|[:,;.?!]\s|[:,;.?!]?$|\)|\])`)
