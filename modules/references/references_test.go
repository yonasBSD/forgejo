...
func TestRegExp_mentionPattern(t *testing.T) {
	trueTestCases := []struct {
		...
		{"@ANT_123@example.com.com", "@ANT_123@example.com.com"},
		{
			"@xxx-DiN0-z-A..uru..s-xxx@example.com",
			"@xxx-DiN0-z-A..uru..s-xxx@example.com",
		},

		{"   @lol@example.com   ", "@lol@example.com"},
		{" @Te-st@example.com", "@Te-st@example.com"},
		{"(@gitea@example.com)", "@gitea@example.com"},
		{"[@gitea@example.com]", "@gitea@example.com"},
		{"@gitea@example.com! this", "@gitea@example.com"},
		{"@gitea@example.com? this", "@gitea@example.com"},
		{"@gitea@example.com. this", "@gitea@example.com"},
		{"@gitea@example.com, this", "@gitea@example.com"},
		{"@gitea@example.com; this", "@gitea@example.com"},
		{"@gitea@example.com!\nthis", "@gitea@example.com"},
		{"\n@gitea@example.com?\nthis", "@gitea@example.com"},
		{"\t@gitea@example.com.\nthis", "@gitea@example.com"},
		{"@gitea@example.com,\nthis", "@gitea@example.com"},
		{"@gitea@example.com;\nthis", "@gitea@example.com"},
		...
		{"@gitea@example.com,", "@gitea@example.com"},
		{"@gitea@example.com;", "@gitea@example.com"},
		//		{"@gitea/team1;", "@gitea/team1"}, TODO: circle back when implementing teams federation
		{"@jess@example.com'", "@jess@example.com"},
		{"@forgejo@example.com's", "@forgejo@example.com"},
		{"@example@xn--42.com", "@example@xn--42.com"},
		{"@example@top.secret.co.uk", "@example@top.secret.co.uk"},
		{"@e.xample@local.com", "@e.xample@local.com"},
	}
