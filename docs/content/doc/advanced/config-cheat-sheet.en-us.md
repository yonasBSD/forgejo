...
- `CA_FILE`: **<empty>**: CA file path used for TLS client certifiacte authentication. When used, enforces client certificate usage and prevents TLS tunnel otherwise. Paths are relative to `CUSTOM_PATH`.
